...
Place this in your HTML
	...
	<img src="../Scripts/IMAGESDIR/u.gif" name="imgfirst" width="9" height="9" border="0" >
...
/*
imgout=new Image(15,8);
imgin=new Image(15,8);

/////////////////BEGIN USER EDITABLE///////////////////////////////
	imgout.src="../media/up.png";
	imgin.src="../media/down.png";
///////////////END USER EDITABLE///////////////////////////////////
...
function shoh(id) { 
	...
	if (document.getElementById) { // DOM3 = IE5, NS6
		if (document.getElementById(id).style.display == "none"){
			...
			document.getElementById(id+"_button").value="Click to hide";
			//filter(("img"+id),'imgin');			
		} else {
			
			//filter(("img"+id),'imgout');
			document.getElementById(id+"_button").value="Click to show";
